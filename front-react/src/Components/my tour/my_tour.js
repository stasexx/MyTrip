...
import image_20 from "./../../img/icon/1827951.png";
...
import image_58 from "./../../img/icon/image 58.png";

const Tour_my = ({tour_id,past}) => {
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            {past ? (
                                    ...
                                    <>
                                    <a href="mytour/edit"> <img src={image_58}  className={styles.tour__img}/>Mark</a>
                                    <div className={styles.name}>{tour.rate}/5</div>
                                    </>
                             
                                ) : (
                                    <a href="mytour/edit" className={styles.ediit}> <img src={image_20}  className={styles.tour__img}/> Edit</a>
